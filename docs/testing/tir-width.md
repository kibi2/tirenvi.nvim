...
|  | visual 選択で複数列選択<br>visual 選択で複数表選択<br>範囲選択で複数表選択 | Tir width=n | 選択した列幅が指定した値になる | 2026/4/12 |  | feat: allow column width resizing for tables and columns within selection |
|  | visual block選択で複数表の列を選択 | Tir width- | 選択した列幅が減少する | 2026/4/12 |  |  |
